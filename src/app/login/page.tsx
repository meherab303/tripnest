  ...
  return (
    <div className="my-10">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="card w-[70%] sm:h-[100%] md:sm:h-[100%] lg:h-[80%] shadow-xl bg-base-100">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
          <div className="bg-slate-100 text-center flex justify-center items-center rounded-full">
        ...
        Login <span className="text-accent">Here</span>
          ...
          <div className="flex justify-center mb-10 lg:mt-2">
